...
def get_data():
    data_x_train = pd.read_csv('.')
    x_train = data_x_train.iloc[:, :]

    data_y_train = pd.read_csv('.')
    y_train = data_y_train.iloc[:, :]

    data_x_val = pd.read_csv('.')
    x_val = data_x_val.iloc[:, :]

    data_y_val = pd.read_csv('.')
    y_val = data_y_val.iloc[:, :]
